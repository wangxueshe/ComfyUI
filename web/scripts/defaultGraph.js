export const defaultGraph = {
    ...
    nodes: [{
        ...
        widgets_values: ["disable", 375149258034664, "randomize", 20, 8, "dpmpp_2m", "karras", 0, 20, "disable"]
    }, {
        id: 175,
        type: "FromBasicPipe",
        pos: [4135, -346],
        ...
        widgets_values: [2, 236365921690652, "randomize", 20, 8, "euler", "normal", 0.2, "Linear", 512, 512, 8, 32, "None", 1, 64, 8, 16, true, false]
    }, {
        id: 183,
        ...
        widgets_values: ["\"0\":\"\",\n\"8\":\"\"", 120, false, "Photo of a embedding:altman-lr-1e-3 man", "t-shirt, in the forest", 0, 0, 0, 0, 0]
    }, {
        id: 102,
        ...
        properties: {
            "Node name for S&R": "GaussianLatentImage"
        },
        widgets_values: [512, 512, 16, 0.1]
    }, {
        id: 32,
    ...
    links: [
        ...
        [398, 223, 0, 253, 0, "LATENT"],
        [399, 260, 0, 253, 1, "LATENT"],
        [404, 32, 1, 42, 1, "CLIP"],
        [405, 32, 1, 6, 0, "CLIP"],
        [406, 32, 1, 202, 0, "CLIP"],
        [408, 42, 0, 217, 0, "*"],
